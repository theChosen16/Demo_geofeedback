...
async def add_security_headers(request: Request, call_next):
    ...
    response.headers["Content-Security-Policy"] = (
        ...
        "font-src 'self' data: https://fonts.gstatic.com https://cdnjs.cloudflare.com https://*.perplexily.ai; "
        "img-src 'self' data: blob: https://*.googleapis.com https://*.gstatic.com https://earthengine.googleapis.com https://*.google.com https://*.googleusercontent.com https://cdn.jsdelivr.net; "
